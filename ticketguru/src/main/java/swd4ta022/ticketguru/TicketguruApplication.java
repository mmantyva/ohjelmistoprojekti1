	...
	@Bean
	 public CommandLineRunner demo(VentRepository ventrepository, VenueRepository vrepository, TypeRepository typerepository, TransactionRepository trrepository, TicketRepository ticketrepository, AppuserRepository arepository) {
		 return (args)->{
				...
				/*
				 * //demodataa, aja tämä vain kerran sen jälkeen, kun olet asentanut pysyvän
				 * tietokannan. muuten tulee tuplia Venue venue1 = new Venue("Tavastia",
				 * "Urhokekkosenkatu", "00100", "Helsinki"); Venue venue2 = new
				 * Venue("Finlandiatalo", "Mansku", "00100", "Helsinki"); Venue venue3 = new
				 * Venue("Lutakko", "Lutakonaukio 3", "40100", "Jyväskylä");
				 * vrepository.save(venue1); vrepository.save(venue2); vrepository.save(venue3);
				 * 
				 * Vent vent1 = new Vent("Iso D", "11.11.2022", "Danny", "Kuvaus1", 2000,
				 * vrepository.findByVenuename("Tavastia").get(0)); Vent vent2 = new
				 * Vent("Konsertti", "22.1.2021. klo. 19", "Armi", "Kuvaus2", 2000,
				 * vrepository.findByVenuename("Finlandiatalo").get(0));
				 * ventrepository.save(vent1); ventrepository.save(vent2);
				 * 
				 * Type type1 = new Type("Child", 10.0); Type type2 = new Type("Adult", 30.0);
				 * Type type3 = new Type("Student", 15.0); typerepository.save(type1);
				 * typerepository.save(type2); typerepository.save(type3);
				 * 
				 * 
